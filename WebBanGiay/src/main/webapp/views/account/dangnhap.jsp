        ...
        <div class="container pt-5 pb-5" id="screen">
            <div class="row"> <!--row Start-->
                <div class="col-lg-6 my-auto"> <!--col-lg-6 Start-->
                    <div id="login">
                        <form name="frmdn" action = "/account/dangnhap" method = "post"> <!-- Form Start -->
                            <h4>
                                Chào mừng bạn đến với
                                <span class="text-success">HK2T</span>
                            </h4>
                            <p class="text-muted">
                            ...
                            <div class="form-floating mb-3">
                                <input required ng-model="u" name="username" type="text" class="form-control"
                                    placeholder="Nhập username">
                                <label>
                                    USERNAME
                                </label>
                                <em class="text-danger" ng-show="frmdn.username.$invalid"> ${message}</em>
                            </div>
                            <!-- PASSWORD -->
                            <div class="form-floating mb-3">
                                <input required ng-model="p" name="password" type="password" class="form-control"
                                    placeholder="Nhập mật khẩu">
                                <label>
                                    PASSWORD
                                </label>
                                <em class="text-danger" ng-show="frmdn.password.$invalid"> ${message1}</em>
                            </div>
                        ...
                        <div class="text-center text-muted mt-2 mb-0" style="font-size:14px;">
                            ...
                            <a href="/account/dangky" class="text-primary text-decoration-none">
                                Đăng ký tại đây
                            </a>
                        </div>
                        <!--Sign Up End-->
                ...
                <div class="col-lg-6 login-image d-none d-lg-block my-auto">
                    <img src="/assets/img/images/login-image-shoe.png" class="w-100" alt="Login Image">
                </div>
            </div> <!--row End-->
        </div>
    </main>
