...
<body class="dark">
	...
	<div class="wrapper">
		...
		<div class="main wrapper">
			...
			<main class="content px-3 py-4 mt-3">
				...
				<div class="row">
					<div class="card">
						<div class="card-header bg-primary text-light text-center">CHỈNH
							SỬA THÔNG TIN SLIDE</div>
						<div class="card-body">
							<form:form method="post" action="/quanlislide/update"
								modelAttribute="slide" enctype="multipart/form-data">
								<!-- Hidden field để giữ maslide -->
								<form:hidden path="maslide" />
								...
								<c:if test="${not empty imageName}">
									<div class="mb-3">
										<label for="CurrentFile" class="form-label">Hình ảnh
											hiện tại</label><br /> <img
											src="/assets/img/slide/${slide.anhdaidien}"
	...
	<script>
		function validateTrangThai() {
			...
			document.getElementById("trangThaiError").innerText = error;
		}
	</script>
</body>
</html>