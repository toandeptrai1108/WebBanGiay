...
<body>
	<aside id="sidebar">
		...
		<ul class="sidebar-nav list-unstyled">
			...
			<li class="sidebar-item">
				<a href="/quanlidanhgia/listDanhGia" class="sidebar-link"> <i class="fa-solid fa-comment"></i><span>Quản lý đánh giá</span></a>
			</li>
			<li class="sidebar-item">
				<a href="/khuyenmai/indexKhuyenMai" class="sidebar-link"> <i class="fa-solid fa-rectangle-ad"></i></i><span>Quản lý khuyến mãi</span></a>
			</li>
			<li class="sidebar-item">
